...
#!RemoteAsset:  sha256:23e233413926ef735f7d87024466cfda5a4b87467730846bd82ea7d504121347
...
Requires:       crate(include-flate-codegen-0.3) >= 0.3.3
Requires:       crate(include-flate-compress-0.3) >= 0.3.3
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(include-flate-codegen-0.3/deflate) >= 0.3.3
Requires:       crate(include-flate-compress-0.3/deflate) >= 0.3.3
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(include-flate-codegen-0.3/no-compression-warnings) >= 0.3.3
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(include-flate-codegen-0.3/zstd) >= 0.3.3
Requires:       crate(include-flate-compress-0.3/zstd) >= 0.3.3
