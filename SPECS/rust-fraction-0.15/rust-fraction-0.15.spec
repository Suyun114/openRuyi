...
#!RemoteAsset:  sha256:864d054a996544d325470be9db9ff3be18319e568ad90b3b59f1b8bea046ab2f
...
Requires:       crate(num-0.4/num-bigint) >= 0.4.0
Requires:       crate(num-0.4/std) >= 0.4.0
...
Requires:       crate(num-0.4/serde) >= 0.4.0
